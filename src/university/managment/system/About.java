...
public class About extends  JFrame{
    About(){
        ...
        JLabel name = new JLabel("Developed By: Yuvraj Verma");
        name.setBounds(70, 220, 550, 40);
        name.setFont(new Font("Tahoma", Font.BOLD, 30));
        add(name);
        
        JLabel rollno = new JLabel("Enrollment No: 20ADV3CSE0048");
        rollno.setBounds(70, 280, 550, 40);
        rollno.setFont(new Font("Tahoma", Font.PLAIN, 30));
        add(rollno);
        
        JLabel contact = new JLabel("Email ID: varma.yash18@gmail.com");

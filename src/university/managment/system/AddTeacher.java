...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    JTextField tfname, tffname, tfaddress, tfaadhar, tfphone, tfxii, tfx, tfemail;
    JLabel  labelempId;
    JDateChooser dcdob;
    ...
    AddTeacher(){
        ...
        labelempId = new JLabel("6263"+first4);
        ...
        String course[] = {"B.Tech", "M.Tech", "BCA", "MCA", "BBA", "MBA", "B.Sc", "B.Com", "M.Com", "MA", "BA"};
        ...
        String branch[] = {"Computer Science And Engineering", "Civil", "Information Technology", "Mechanical", "Management", "Design"};
